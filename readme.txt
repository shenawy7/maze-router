How to use:
	...
	The user must input the size of the grid and the number of layers along side an input file that will specify the pins and their corresponding layers and coordinates as shown in the example in the handout
